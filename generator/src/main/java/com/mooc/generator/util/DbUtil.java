package com.mooc.generator.util;
...
public class DbUtil {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            String url = "jdbc:mysql://localhost:3306/course-imooc?characterEncoding=UTF8&autoReconnect=true";
            String user = "courseimooc";
            String pass = "199511haO.";
    ...
    public static String getTableComment(String tableName) throws Exception {
        ...
        stmt.close();
        conn.close();
        System.out.println("TableName：" + tableNameCH);
        return tableNameCH;
    }

    /**
     * get all cols information
     * @param tableName
     * @return
     * @throws Exception
     */
...
//                }
        ...
        stmt.close();
        conn.close();
        System.out.println("col information: " + fieldList);
        return fieldList;
    }
    ...
    /**
     * sql type is converted to java type
     */
